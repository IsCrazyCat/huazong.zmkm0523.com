<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./application/admin/view2/user\ajaxindex.html";i:1567817846;}*/ ?>
        ...
        <?php if(is_array($userList) || $userList instanceof \think\Collection || $userList instanceof \think\Paginator): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <tr data-id="<?php echo $list['user_id']; ?>">
                ...
                <td align="center" class="">
                    <div style="text-align: center; width: 400px; max-width:400px;">
                ...
                <td align="left" class="" >
                    <div style="text-align: center; width: 80px;"><?php echo $level[$list[level]]; ?></div>
                </td>
                <td align="left" class="">
                ...
                <td align="left" class="">
                    <div style="text-align: center; width: 80px;"><?php echo (isset($first_leader[$list[user_id]]['count']) && ($first_leader[$list[user_id]]['count'] !== '')?$first_leader[$list[user_id]]['count']:"0"); ?></div>
                </td>
                <td align="left" class="">
                ...
                <td align="left" class="">
                    <div style="text-align: center; width: 100px;"><?php echo $list['frozen_money']; ?></div>
                </td>
                <td align="left" class="">
