<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"./template/mobile/new2/user\Index.html";i:1567818341;s:41:"./template/mobile/new2/public\header.html";i:1567818311;s:45:"./template/mobile/new2/public\footer_nav.html";i:1567818311;s:43:"./template/mobile/new2/public\wx_share.html";i:1567818311;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
            ...
            <!--<a href="">-->
                ...
                <div class="fl lors" style="text-align: center;height:2.688rem;padding:0.8rem 0.3rem;margin:0;">
                  <div style="padding:0.1rem 0;">
                    ...
                    <span style="float:left; font-size:0.6rem;padding:0.1rem 0;"  >〖<?php if($user[level] == 2): ?>销售代表<?php elseif($user[level] == 3): ?>业务经理<?php elseif($user[level] == 4): ?>高级经理<?php else: ?>注册会员<?php endif; ?>〗</span>
