<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view2/user\index.html";i:1567817846;s:44:"./application/admin/view2/public\layout.html";i:1567817843;}*/ ?>
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline"  id="search-form2" onSubmit="return false">
                ...
                <div class="sDiv">
                    <div class="sDiv2">
                        <input type="text" id="search_key" size="30" class="qsbox" placeholder="手机或者昵称...">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 80px;" class="">一级代理数</div>
                        </th>
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 80px;" class="">二级代理数</div>
                        </th>
                        <!--<th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 80px;" class="">三级代理数</div>
                        </th>-->
                        ...
                        <th align="center" abbr="pay_points" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">冻结余额</div>
                        </th>
